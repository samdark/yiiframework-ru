    ...
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
        ...
        <div class="tabbable tabs-right">
            ...
            <ul class="nav nav-tabs">
                <li <?= (Yii::$app->request->get('sort') == 'created_at' || Yii::$app->request->get('sort') == '-created_at') ? 'class = "active"' : '' ?>>
                    <?= $sort->link('created_at', [
                        'label' => Yii::t('qa', 'by date')
                    ]) ?></li>
                <li <?= (Yii::$app->request->get('sort') == 'view_count' || Yii::$app->request->get('sort') == '-view_count') ? 'class = "active"' : '' ?>>
                    <?= $sort->link('view_count', [
                        'label' => Yii::t('qa', 'by views')
                    ]) ?></li>
                <li <?= (Yii::$app->request->get('sort') == 'favorite_count' || Yii::$app->request->get('sort') == '-favorite_count') ? 'class = "active"' : '' ?>>
                    <?= $sort->link('favorite_count', [
                        'label' => Yii::t('qa', 'by subscribers')
                    ]) ?></li>
            </ul>
        </div>
